module.exports = {
  ...
  deploy: {
    production: {
      ...
      "post-deploy": "export PATH=$PATH:$(npm bin -g) && cd /home/azureuser/Stockpikr-Back-End && git pull && yarn install && pm2 startOrRestart ecosystem.config.js --env production"
